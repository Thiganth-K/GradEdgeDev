...
const Sidebar: React.FC = () => {
  ...
  const facultyName = faculty?.username || 'Faculty';
  ...
  const menuItems = [
    ...
    { name: 'Announcements', path: '/faculty/announcements', icon: (
    ...
    ,{ name: 'My Tests', path: '/faculty/tests', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6M12 9v6M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
    )}
  ];
        ...
        <div className="p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <p className="text-white font-medium text-sm">{facultyName}</p>
              <p className="text-red-300 text-xs">Faculty</p>
            </div>
          </div>
