        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-3">
              <button
                onClick={() => navigate('/contributor/library')}
                className="px-6 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 font-semibold flex items-center space-x-2"
              >
